...
public class HelpNeutral extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnMain.setText("Return to Login");
        btnMain.setToolTipText("Return to Login Screen\n");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(99, 99, 99)
                                .addComponent(btnMain, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void lblMinimiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMinimiMouseClicked
        this.setState(HelpNeutral.ICONIFIED);
...
System.exit(0);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HelpNeutral().setVisible(true);
            }
        });
    }
